...
type AdminService interface {
	...
	CreateClass(className string, majorID int, adminUserID int64, ip, userAgent string) error
	...
	GetAuditLogs(activityType, search string, page, limit int) ([]AuditLogItem, int, int, int, error)
}
