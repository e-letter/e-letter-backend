...
type LetterCreateRequest struct {
	...
	RequestDateEnd string  `json:"request_date_end"`
...
func (r LetterCreateRequest) IsMultiDay() bool {
	return r.RequestDateEnd != "" && r.RequestDateEnd != r.RequestDate
}
...
type LetterRepository interface {
	...
	ListPrincipalApprovals(userID int, typeKey string, page, limit int) (*PaginatedLetterResponse, error)
