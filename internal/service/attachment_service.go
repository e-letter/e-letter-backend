...
func (s *attachmentService) Create(requestID int, filePath, originalName, mimeType string, fileSize int64) (int, error) {
	return s.repo.Create(requestID, filePath, originalName, mimeType, fileSize)
}
